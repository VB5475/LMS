...
export default function CourseDetailScreen() {
 ...
 const videoId = id ?? "";
 const bookmarked = isSaved(videoId);
 ...
 const instructorName =
  getInstructorName(instructor) || getCourseChannel(course!);
 ...
 useEffect(() => {
  navigation.setOptions({
   headerRight: () => (
    <TouchableOpacity
     onPress={() => toggleSaveCourse(videoId)}
 ...
 async function handleEnroll() {
  ...
  setEnrolling(false);
  Alert.alert("Enrolled! 🎉", "You can now watch this course.", [
   { text: "Got it" },
  ]);
 }
       ...
       {course.statistics?.likeCount && (
        <View style={styles.statItem}>
         ...
         <Text style={styles.statText}>
          {getCourseViews({
           ...course,
           statistics: { viewCount: course.statistics.likeCount },
          })}{" "}
          likes
         </Text>
        </View>
